...
public:
	...
	{
		return *reinterpret_cast<vector3d*>(uintptr_t(this) + 0x120);
	}
	...
	vector3d& get_abs_origin()
	{
		using original_fn = vector3d&(__thiscall*)(PVOID);
		return u::call_vfunc<original_fn>(this, 9)(this);
	}

	vector3d get_eye_position()
	{
		return *reinterpret_cast<vector3d*>(uintptr_t(this) + 0xFC) + get_abs_origin(); // m_vecViewOffset[0]
	}
